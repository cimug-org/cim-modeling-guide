...
!!! Note
    ...
    When referencing an offline PDF version of this guide it is recommended to confirm it corresponds to the latest publicaly available guide at [https://cim-mg.ucaiug.io](https://cim-mg.ucaiug.io). 
